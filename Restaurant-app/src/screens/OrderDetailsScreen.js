    ...
    <ScrollView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={styles.content}>
        ...
        {order.deliveryPartnerId && (
          <View style={[styles.section, { backgroundColor: theme.card }]}>
            <Text style={[styles.sectionTitle, { color: theme.text }]}>Delivery Partner</Text>
            <View style={styles.infoRow}>
              <Text style={[styles.infoLabel, { color: theme.subtext }]}>Name:</Text>
              <Text style={[styles.infoValue, { color: theme.text }]}>{order.deliveryPartnerId.name}</Text>
            </View>
            <View style={styles.infoRow}>
              <Text style={[styles.infoLabel, { color: theme.subtext }]}>Phone:</Text>
              <Text style={[styles.infoValue, { color: theme.text }]}>{order.deliveryPartnerId.phone || 'N/A'}</Text>
            </View>
          </View>
        )}
